...
2022.3.24. this is a simple chatbot that takes your text input,
processes it with a markov chain algorithm, and then spits out
...
`cd ~/Documents/creative-coding-2/PROJECT-NAME/`

(use tab after three characters to auto-fill
name, also helps to confirm you're in the right place)

(to see the contents of your current folder, write 'ls')
...
info about uploading a repository to github:
...
git branch -M main
git remote add origin git@github.com:abbymachines/test.git
